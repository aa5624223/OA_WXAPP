...
Page({
  ...
  subCanvas(){//提交图片
    ...
    //ctx.translate(0,Memory.signImg.height);
    //ctx.rotate(-90 * Math.PI / 180);
    //ctx.width = Memory.signImg.height;
    //ctx.height = Memory.signImg.width;
    //ctx.draw();
    ...
    wx.canvasToTempFilePath({
      ...
      width: canvasWidth,
      height: canvasHeight,
      destWidth: canvasWidth*0.5,
      destHeight: canvasHeight*0.5,
      canvasId: 'handWriting',
      success(res) {
        Memory.signImg.signUrl = res.tempFilePath;
        Memory.signImg.width = canvasWidth*0.5;
        Memory.signImg.height = canvasHeight*0.5;
        wx.navigateTo({
